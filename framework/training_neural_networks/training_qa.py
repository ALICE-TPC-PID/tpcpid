...
for i, mass in enumerate(np.sort(np.unique(fit_data[:,labels=='fMass'].flatten()))):
    ...
    if IsSmallSystem:
        ...
        QA2D_NSigma_vs_Var(i, mass, plot_against = 'fFt0Occ', log_x = False, range_hists = [[-0.1,2.]]*6, xlabel = r'norm. FT0 occupancy')
        QA2D_NSigma_vs_Var(i, mass, plot_against = 'fFt0Occ', log_x = False, range_hists = [[-0.1,2.]]*6, useNN=False, xlabel = r'norm. FT0 occupancy')
        QA2D_NSigma_vs_Var(i, mass, plot_against = 'fFt0Occ', log_x = False, range_hists = [[-0.1,2.]]*6, xlabel = r'norm. FT0 occupancy', plot_mode="rel_sigma")
        QA2D_NSigma_vs_Var(i, mass, plot_against = 'fFt0Occ', log_x = False, range_hists = [[-0.1,2.]]*6, xlabel = r'norm. FT0 occupancy', plot_mode="raw_relsigma_fitted")
    else:
